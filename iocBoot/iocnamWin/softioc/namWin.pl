...
BEGIN
{
	...
	#! $ENV{IOC_BINARY}="namWin";
	
	
	# Top-level bin directory for the IOC
	$ENV{IOC_BIN_DIR}="$ENV{TOP}/bin";
	#! $ENV{IOC_BIN_DIR}="/home/username/epics/synApps/support/namWin/bin";
	...
	#! $ENV{IOC_STARTUP_DIR}="/home/username/epics/ioc/synApps/namWin/iocBoot/iocnamWin";
	...
	#! $ENV{IOC_COMMAND_DIR}="/home/username/epics/ioc/synApps/namWin/iocBoot/iocnamWin/softioc/commands";
